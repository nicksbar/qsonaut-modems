...
The primary compatibility reference was the official JS8Call repository:
...
under `~/.cache/rigforge/oracles/js8call`. The optional corpus test accepts a
path to that external checkout and skips it when no path is provided.
